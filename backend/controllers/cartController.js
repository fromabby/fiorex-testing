...
//     const cart = await User.findByIdAndUpdate(req.user.id, { cart: req.body }, {
//         new: true,
//         runValidators: true,
//         useFindAndModify: false
//     })
...
//     const cart = await User.findByIdAndUpdate(req.user.id, { cart: newCart }, {
//         new: true,
//         runValidators: true,
//         useFindAndModify: false
//     })
...
//     //will update
//     const product = await Product.findById(req.params.id)
//     var productList = req.user.cart
//     //IF EXISITING RETURN, ELSE ADD
//     var newProduct = productList.filter(data => data.product._id.toString() !== product._id.toString())

//     const cart = await User.findByIdAndUpdate(req.user.id, { cart: newProduct }, {
//         new: true,
//         runValidators: true,
//         useFindAndModify: false
//     })
